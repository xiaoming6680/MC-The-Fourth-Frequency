...
本目录描述 `0.4.0-beta` 的当前实现。玩法数字以源码中的策略类、协议 DTO、资源目录和实际完成的验证为准。历史计划不作为玩法说明。
...
| [HIM 美术流程](art/him/README.md) | HIM 参考图、材质与运行时纹理契约 | 美术、渲染开发 |
| [世界接口美术流程](art/world_interface/README.md) | 三形态本体 UV、布局与材质契约 | 美术、渲染开发 |
